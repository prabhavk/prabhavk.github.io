...
var createEmtr = (() => {
  ...
  return (
function(createEmtr) {
  createEmtr = createEmtr || {};

var Module = typeof createEmtr != "undefined" ? createEmtr : {};
...
if (!Object.getOwnPropertyDescriptor(Module["ready"], "_run_with_json")) {
 Object.defineProperty(Module["ready"], "_run_with_json", {
  configurable: true,
  get: function() {
   abort("You are getting _run_with_json on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_run_with_json", {
  configurable: true,
  set: function() {
   abort("You are setting _run_with_json on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}

if (!Object.getOwnPropertyDescriptor(Module["ready"], "_set_line_buffered_c")) {
 Object.defineProperty(Module["ready"], "_set_line_buffered_c", {
  configurable: true,
  get: function() {
   abort("You are getting _set_line_buffered_c on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_set_line_buffered_c", {
  configurable: true,
  set: function() {
   abort("You are setting _set_line_buffered_c on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}

if (!Object.getOwnPropertyDescriptor(Module["ready"], "_EM_main_entry_c")) {
 Object.defineProperty(Module["ready"], "_EM_main_entry_c", {
  configurable: true,
  get: function() {
   abort("You are getting _EM_main_entry_c on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_EM_main_entry_c", {
  configurable: true,
  set: function() {
   abort("You are setting _EM_main_entry_c on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}

if (!Object.getOwnPropertyDescriptor(Module["ready"], "_setDayhoffMatrixPath")) {
 Object.defineProperty(Module["ready"], "_setDayhoffMatrixPath", {
  configurable: true,
  get: function() {
   abort("You are getting _setDayhoffMatrixPath on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_setDayhoffMatrixPath", {
  configurable: true,
  set: function() {
   abort("You are setting _setDayhoffMatrixPath on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}
...
(function() {
 ...
 var loadPackage = function(metadata) {
  ...
  var PACKAGE_NAME = "public/wasm/emtr.data";
  var REMOTE_PACKAGE_BASE = "emtr.data";
  ...
  function runWithFS() {
   ...
   function processPackageData(arrayBuffer) {
    ...
    Module["removeRunDependency"]("datafile_public/wasm/emtr.data");
   }
   Module["addRunDependency"]("datafile_public/wasm/emtr.data");
 ...
 loadPackage({
  ...
  "package_uuid": "f66486e9-b4df-41a9-a80d-6fd5c58e4d67"
 });
})();
...
if (Module["locateFile"]) {
 wasmBinaryFile = "emtr.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("emtr.wasm", import.meta.url).toString();
}
...
var _set_line_buffered_c = Module["_set_line_buffered_c"] = createExportWrapper("set_line_buffered_c");

var _setDayhoffMatrixPath = Module["_setDayhoffMatrixPath"] = createExportWrapper("setDayhoffMatrixPath");

var _run_with_json = Module["_run_with_json"] = createExportWrapper("run_with_json");

var _EM_main_entry_c = Module["_EM_main_entry_c"] = createExportWrapper("EM_main_entry_c");
...
run();
  ...
  return createEmtr.ready
}
);
})();
export default createEmtr;